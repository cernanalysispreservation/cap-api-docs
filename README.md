...
[![Build Status](https://travis-ci.com/pamfilos/cap-api-docs.svg?branch=master)](https://travis-ci.com/pamfilos/cap-api-docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://pamfilos.github.io/cap-api-docs/)
- OpenAPI Raw Files: [JSON](https://pamfilos.github.io/cap-api-docs/openapi.json) [YAML](https://pamfilos.github.io/cap-api-docs/openapi.yaml)
